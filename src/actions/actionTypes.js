...
export const LOAD_URLS_BY_COMPANY_LIST_SUCCESS = 'LOAD_URLS_BY_COMPANY_LIST_SUCCESS';
export const LOAD_URLS_BY_COMPANY_LIST_FAIL = 'LOAD_URLS_BY_COMPANY_LIST_FAIL';
